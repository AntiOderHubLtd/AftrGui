--[[
        Aftr UI Library
        All rights reserved.
        © AntiOder Hub Ltd. 2025.
]]



if game.CoreGui:FindFirstChild("AftrGui") then
   game.CoreGui:FindFirstChild("AftrGui"):Destroy()
end

local ScreenGui1 = Instance.new("ScreenGui")
ScreenGui1.Parent = game.CoreGui
ScreenGui1.Name = "AftrGui"
...
TextLabel1.Text = "Aftr UI Library"
